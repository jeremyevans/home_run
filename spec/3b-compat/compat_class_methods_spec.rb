...
describe "Date/DateTime class methods" do
  ...
  ruby_version_is "1.9" do
    it "#valid_civil? should return true if valid or false if not" do
    ...
    it "#valid_commercial? should return true if valid or false if not" do
    ...
    it "#valid_jd? should return true" do
      Date.valid_jd?(2454156).should == true
      Date.valid_jd?(2454156, 1).should == true
    end

    it "#valid_ordinal? should return true if valid or false if not" do
